...
public class SecondGallery extends AppCompatActivity {
            ...
            protected void populateViewHolder(GalleryActivity.ModelViewHolder viewHolder, Model model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent fullintent=new Intent(SecondGallery.this,FullSecond.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(SecondGallery.this, GallerysContainerActivity.class));
