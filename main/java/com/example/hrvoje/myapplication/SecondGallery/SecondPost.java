...
public class SecondPost extends AppCompatActivity {
    ...
    private void startPosting() {
        ...
        if(!TextUtils.isEmpty(tile_val)&&mimageUri!=null){
            ...
            StorageReference filepath=mStorage.child("Blog_imagesecond").child(mimageUri.getLastPathSegment());
            ...
            filepath.putFile(mimageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    DatabaseReference newPost=sDatabase.push();
                    ...
                    startActivity(new Intent(SecondPost.this,MainActivity.class));
                    finish();
                }
            });
        }
